...
const injectStyles = () => {
  ...
  s.textContent = `
    ...
    .qb-root {
      ...
      animation: qb-bg-pan 18s ease-in-out infinite alternate;
    }
    ...
    .qb-hero {
      ...
      gap: 12px;
      animation: qb-fade-up .45s ease both;
    }
    ...
    .qb-panel {
      ...
      animation: qb-fade-up .45s .06s ease both;
    }
        ...
        <Card className="qb-panel mb-6">
          <CardContent className="pt-6">
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-1 gap-4 xl:col-span-1">
        ...
        <div className="space-y-4">
          {loading ? (
            ...
            questions.map((question) => {
              return (
                <Card key={question.id} className="qb-question-card">
