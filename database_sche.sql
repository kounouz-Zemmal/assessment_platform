...
CREATE TABLE public.assessment_proctoring_config (
...
CREATE TABLE public.proctoring_tab_activity (
  id bigint NOT NULL DEFAULT nextval('proctoring_tab_activity_id_seq'::regclass),
  assessment_id bigint NOT NULL,
